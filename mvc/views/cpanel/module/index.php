                ...
                <tbody>
                    <?php foreach ($data['datas'] as $key => $val) { ?>
                        <tr class="even<?= $val['id'] ?> pointer">
                            ...
                            <td class=""><input type="number" data-control="<?= $data["template"] ?>" id="sort<?= $val['id'] ?>" value="<?= $val['sort'] ?>"></td>
                        ...
                        <?php if (isset($val['children']) && $val['children'] != NULL) { ?>
                            <?php foreach ($val['children'] as $key_child => $val_child) { ?>
                                <tr class="even<?= $val_child['id'] ?> pointer">
                                    ...
                                    <td class=""><input type="number" data-control="<?= $data["template"] ?>" id="sort<?= $val_child['id'] ?>" value="<?= $val_child['sort'] ?>"></td>
